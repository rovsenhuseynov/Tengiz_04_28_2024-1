export const getScreenConfig = (width, height) => {
  const screenConfig = [
    ...
    { minWidth: 1024, minHeight: 600, speed: 0.1, offset: -30, backgroundSize:'cover'},
    ...
    { minWidth: 414, minHeight: 896, speed: 0.2, offset: -90, backgroundSize: '430%' },
    ...
    { minWidth: 375, minHeight: 667, speed: 0.2, offset: -80, backgroundSize: '350%'}, //  <--- ГОТОВ
