...
import "./TraditionalDrinks.scss";
import SlidersComponent from "../../../../Components/reusableComponents/SlidersSwiper/SlidersComponent";
import { drinksMenuData } from "../../../../Components/reusableComponents/DataBox/Menu_Data";
...
const MenuItem = ({ item, openPopup }) => {
  ...
  return (
    <div className="traditional-drinks-card menu-card">
...
const TraditionalDrinks = () => {
  return (
    <div className="traditional-drinks">
      <h2 className="traditional-drinks__title">Traditional</h2>
      <SlidersComponent
        data={drinksMenuData}
