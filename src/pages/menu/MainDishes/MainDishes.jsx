...
import "./MainDishes.scss";
import SlidersComponent from "../../../Components/reusableComponents/SlidersSwiper/SlidersComponent";
import { mainDishesData } from "../../../Components/reusableComponents/DataBox/Menu_Data";
...
const MenuItem = ({ item, openPopup }) => {
  ...
  return (
    <div className="main-dishes-menu-card menu-card">
...
const MainDishes = () => {
  return (
    <div className="main-dishes-menu">
      <h2 className="main-dishes-menu__title">Main Dishes</h2>
      <SlidersComponent
        data={mainDishesData}
